...
const GAME_DATA = {
    ...
    "B": {
        "clues": {
            ...
            "3": {"pass": "L3V-4096~", "text": "Location: Decode URL encoded string: %4C%49%42%52%41%52%59. Passcode: What is the exact Unix timestamp for January 1, 1970, at 01:00:00 UTC? Format exactly as 'EP0CH-[result]?'."},
    ...
    "C": {
        "clues": {
            "1": {"pass": "C-ST@RT#3", "text": "Execute Python logic: \"\".join([chr(x^42) for x in [108, 115, 120, 121, 126, 10, 108, 102, 101, 101, 120, 10, 102, 107, 104]]). Passcode: Total digits in 2^1000, multiplied by 14. Format exactly as 'B!T-[result]$'."},
    ...
    "D": {
        "clues": {
            "1": {"pass": "D-ST@RT#4", "text": "Location: T R Y A S N U I R D E S Y O C L A L C P. Reverse string, extract every 2nd letter from first. Passcode: Sum of ASCII values of 'KALAKKAD' multiplied by 3. Format exactly as '@SC-[result]!'."},
            "2": {"pass": "@SC-1746!", "text": "SQL: Table A has 45 rows, Table B has 102 rows. Cross join total rows? Subtract 50. Format exactly as 'SQL-[result]#'. Location: Caesar cipher shift -5 to 'QNGWFWD'."},
